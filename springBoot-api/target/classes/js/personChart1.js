...
function personcj1 (){
    // 基于准备好的dom，初始化echarts实例
    var personcj1 = echarts.init(document.getElementById('personcj1'));
    charts.push(personcj1);
    // 指定图表的配置项和数据
    var  option = {
        tooltip: {
            formatter: '{a} <br/>{b} : {c}%'
    ...
    setInterval(function () {
        personcj1.setOption(option, true);
    },500);
    // 使用刚指定的配置项和数据显示图表。
    personcj1.setOption(option);
...
function personcj2 (){
    // 基于准备好的dom，初始化echarts实例
    var personcj2 = echarts.init(document.getElementById('personcj2'));
    charts.push(personcj2);
    // 指定图表的配置项和数据
    ...
    setInterval(function () {
        personcj2.setOption(option, true);
    },500);
    // 使用刚指定的配置项和数据显示图表。
    personcj2.setOption(option);
